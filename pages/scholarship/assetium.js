      ...
      >
        ...
        <Box
          ...
          sx={{
            ...
            backgroundSize: "cover",
            backgroundImage: {
              xs: "url(/images/aboutSch.svg)",
              sm: "url(/images/aboutSch.svg)",
            },
            ...
            >
              ...
              >
                <Typography
                  ...
                  sx={{
                    font: {
                      xs: `normal normal 600 normal 32px/48px ${Fonts.openSans}`,
                      md: `normal normal 600 normal 50px/77px ${Fonts.openSans}`,
                    },
                    color: Colors.light,
                    width: "100%",
              ...
              >
                <Typography
                  ...
                  sx={{
                    font: {
                      xs: `normal normal 400 normal 14px/29px ${Fonts.openSans}`,
                      sm: `normal normal 400 normal 14px/28px ${Fonts.openSans}`,
                    },
                    color: Colors.light,
                    width: "100%",
                    textAlign: { xs: "center", sm: "left" },
        ...
        <Box
          sx={{
            ...
            backgroundSize: "cover",
            backgroundImage: {
              xs: "url(/images/Featuressectioncourse.svg)",
              sm: "url(/images/Featuressectioncourse.svg)",
            },
          }}
        >
          <Box
